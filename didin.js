...
const nyoutube = ('©4K Sanzz')  //ubah di config biar ngk emro
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'groupbot': {
                m.reply('Halo Kak\nGroup Sanzz: https://chat.whatsapp.com/JiMMaEr083uDQCl9JO0EdX\nNOTE : Kalo kakak nya Punya Bot Masukin aja\n\n*_Makasih><_*')
            }
            break
            case 'tqto': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Ciee yang Jadian💖 Jangan lupa DONASI Ke *Daffaaa XD*🗿
...
break
            ...
            await didin.sendButtonText('6281236167286@s.whatsapp.net', buttons, pjtxt, nyoutube, m, {mentions: ments})
...
didin.send5ButImg(i, txt, `4K Sanzz`, log0, btn, thum)
}
...
await sleep(1500)
var txtbc = `*Broadcast Daffaaa XD*\n\n*✉️ Message :* ${q? q : ''}\n`
...
if (!isCreator) return replay(mess.owner)
            ...
            didin.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: button, footer: `4K Sanzz`, mentions: [m.sender] })
		}		
            }
            break
            case 'q': case 'quoted': {
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'sand': case 'glue': case '1917': case 'leaves': {
             ...
             didin.sendMessage(m.chat, { image: { url: anu }, caption: `Made by Sanzz` }, { quoted: m })
             }
             break
//━━━━━━━━━━━━━━━[ BATAS ]━━━━━━━━━━━━━━━━━//
...
didin.sendMessage(m.chat, { caption: 'Tu Video Nya | Jangan Lupa subscribe yt Daffaaa XD', video: { url: data.watermark }, buttons: button, footer: `© 𝕯𝕸.𝕳𝕷𝕷`, mentions: [sender] })
})
}
break
case 'tiktokaudio':{
			...
			case 'confess':
				...
				header = 'hayyy'
				 ...
				 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM‡` }, type: 1 }, { buttonId: `sewabot`, buttonText: { displayText: `SEWABOT‡` }, type: 1 }]
					didin.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, buttons: button, footer: `4K Sanzz\nLink Channel YouTube\nhttps://youtube.com/@4KSanzz` })
...
case 'store':{
  ...
  const listMessage = {
   text: `*_Welcome To 4K Sanzz Store_*`,
   footer: "4K Sanzz",
   title: "",
...
buffer = global.thumb
  	anu = `*Hai Kak ${pushname}\nSaya 4K Sanzz WhatsApp Yang Membantu Kamu Mempermudah Membuat Sticker Dll.`
let buttons = [{ buttonId: 'tesrow', buttonText: { displayText: 'LIST MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OTHER' }, type: 1 }]
    didin.sendMessage(m.chat, { caption: `${anu}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: buttons, footer:  `By: 4K Sanzz`, mentions: [m.sender] })
}
break
case 'rules': {
const Jimp = require('jimp')
...
{title: "【️💻】ʙᴏᴛ sᴛᴀᴛᴜs ‹", rowId: `botinfo`, description: `ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ sᴛᴀᴛᴜs 𝕸.𝕳𝕷𝕷`},
]
},
  {
title: "ʙᴇʀɪᴋᴜᴛ ғɪᴛᴜʀ 𝕸.𝕳𝕷𝕷",
rows: [
...
title: "ɪɴғᴏ",
rows: [
{title: "【🔭】sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", rowId: `sc`, description: `sᴄʀɪᴘᴛ 𝕸.𝕳𝕷𝕷 - ʙʏ 𝕸.𝕳𝕷𝕷`},
{title: "【💰】ᴅᴏɴᴀsɪ", rowId: `donasi`, description: `ᴅᴏɴᴀsɪ ʙᴀɴɢ ʙɪᴀʀ ʙᴏᴛ ᴏɴ 24 ᴊᴀᴍ`},
{title: "【❗】ʀᴜʟᴇs", rowId: `rules`, description: `ᴘᴇʀᴀᴛᴜʀᴀɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ 𝕸.𝕳𝕷𝕷`},
{title: "【🥇】ᴄᴏɴᴛʀɪʙᴜᴛᴏʀ", rowId: `tqto`, description: `ʏᴀɴɢ ᴍᴇᴍʙᴀɴᴛᴜ ᴍᴇɴɢᴇᴍʙᴀɴɢᴋᴀɴ 𝕸.𝕳𝕷𝕷`},
{title: "【🌸】ɢʀᴏᴜᴘ ʙᴏᴛ", rowId: `groupbot`, description: `ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ᴊᴏɪɴ ᴋᴀᴡᴀɴ`},
     ]
    }     
    ]

didin.sendListMsg(m.chat, `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Aku 𝕸.𝕳𝕷𝕷 Bot whatsapp multi-device yang dapat membantumu_*`, '', '', `Click Here!`, sections, m)
}
break
case 'gamemenu':{
  // send a list message!
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\n_Berikut Game" Yang Tersedia Di 4K Sanzz_`,
   footer: "4K Sanzz",
   title: "",
   buttonText: "Buka!",
   sections
...
let sections = [
                ...
                didin.sendListMsg(m.chat, `*❏ 4K Sanzz*
...
© 4K Sanzz`, ' ', ' ', `Buka!`, sections, m)
       }
break
case 'donasi': case 'donate': case 'donasi': case 'donasi': {
                didin.sendMessage(m.chat, { image: { url: 'https://i.postimg.cc/PfWW6KZ4/20221218-123431.jpg' }, caption: `*Hi Bro ${m.pushName}*\n*_Jika ingin Donasi Silahkan Scan Gambar Diatas_*

*_Atau Via_*
- Dana : 081236167286
- OVO : 081236167286
- Saweria : https://saweria.co/4ksanzzx
...
let buttons = [{ buttonId: `tesrow`, buttonText: {displayText: 'BACK‡'}, type: 1},{buttonId: `donasi`, buttonText: {displayText: 'DONASI‡'}, type: 1}]
let buttonMessage = {
  document: fs.readFileSync('./DidinMedia/doc/fake.pdf'),
